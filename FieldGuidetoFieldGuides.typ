...
== Aslan Heirate
=== Clan Core Bonuses
#LoreBox[Nine Heavens Strike]

_Flavor text for this sick ability_
...
#FrameAutomatic(lcp, "Hydra", background: image(width: 7in, "images/IPS-N-Background.png"))
#FullPageImageFramed(image("images/Drake-Facing.jpg"))
#LicenseAutomatic(lcp, "Hydra", 1)
#LicenseAutomatic(lcp, "Hydra", 2)
#LicenseAutomatic(lcp, "Hydra", 3)
